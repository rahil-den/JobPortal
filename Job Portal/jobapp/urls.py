...
urlpatterns = [
    ...
    path('employee_table/',views.employee_data_table, name='employee_table'),
    path('categories/', views.category_view, name='category_view'),
    path('categories/delete/<int:category_id>/', views.delete_category, name='delete_category'),
    path('applicants/', views.applicant_table, name='applicant_list'),
    path('job_list/',views.Job_table, name='job_list'),
